...
# Portable export must exist after successful paid run
if [[ ! -f artifacts/rag/portable-export/artifact-manifest.json ]]; then
  echo "WARN: portable artifact manifest missing (paid run may have failed before export)"
fi
