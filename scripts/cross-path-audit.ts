...
const PATTERNS: Array<{ cat: Category; re: RegExp; label: string }> = [
  ...
  { cat: "prior-lesson-ref", re: /الدروس\s+اللي\s+(?:فات[وت]?|قبل)/g, label: "الدروس اللي فاتت/قبل" },
  { cat: "prior-lesson-ref", re: /الموديول\s+اللي\s+فات/g, label: "الموديول اللي فات" },
  { cat: "prior-lesson-ref", re: /الموديول\s+السابق/g, label: "الموديول السابق" },
  ...
  { cat: "prior-lesson-ref", re: /زي\s+ما\s+(?:اتعلمنا|شفنا|قلنا|عملنا|اتفقنا|فهمنا)/g, label: "زي ما اتعلمنا/شفنا/قلنا/عملنا/فهمنا" },
  { cat: "prior-lesson-ref", re: /اللي\s+(?:اتعلمناه|عملناه|بنيناه|شفناه)(?:م)?/g, label: "اللي اتعلمناه/عملناه/بنيناه" },
  { cat: "prior-lesson-ref", re: /بعد\s+ما\s+(?:خلصنا|خلّصنا|اتعلمنا|بنينا|شفنا|فهمنا)/g, label: "بعد ما خلصنا/اتعلمنا/بنينا" },
  { cat: "prior-lesson-ref", re: /لحد\s+دلوقتي\s+(?:اتعلمنا|بنينا|شفنا|فهمنا|عملنا)/g, label: "لحد دلوقتي اتعلمنا/بنينا" },
  { cat: "prior-lesson-ref", re: /في\s+m[0-9]+\b/gi, label: "في m{N}" },
  { cat: "prior-lesson-ref", re: /في\s+(?:Module|موديول)\s+[0-9]+/gi, label: "في Module N / موديول N" },
  { cat: "prior-lesson-ref", re: /في\s+(?:الدرس|الدروس)\s+الـ?\s*[0-9]+/g, label: "في الدرس/الدروس الـ N" },
  { cat: "prior-lesson-ref", re: /في\s+[٠-٩0-9]+\s+دروس\s+بس/g, label: "في N دروس بس" },
  { cat: "prior-lesson-ref", re: /Phase\s*[123]\b/gi, label: "Phase N (label)" },
  ...
  { cat: "next-lesson-ref", re: /(?:في|من)\s+الدرس\s+الجاي/g, label: "في/من الدرس الجاي" },
  { cat: "next-lesson-ref", re: /بعد\s+كده\s+(?:هنشوف|هنبني|هنعمل|هنتعلم)/g, label: "بعد كده هنشوف/هنبني/هنعمل" },
  { cat: "next-lesson-ref", re: /هنبدأ\s+فعل[اًا]?\s+ن(?:بني|عمل|شوف)/g, label: "هنبدأ فعلاً نبني/نعمل" },
  { cat: "next-lesson-ref", re: /هتيجي\s+في\s+m[0-9]+/gi, label: "هتيجي في m{N}" },
  { cat: "next-lesson-ref", re: /بريك\s+سريع\s+قبل\s+ما/g, label: "بريك سريع قبل ما…" },
  { cat: "next-lesson-ref", re: /قبل\s+ما\s+نبدأ\s+نبني\s+فعل[اًا]?/g, label: "قبل ما نبدأ نبني فعلاً" },
  { cat: "next-lesson-ref", re: /قبل\s+ما\s+تدخل\s+m[0-9]+/gi, label: "قبل ما تدخل m{N}" },
  { cat: "next-lesson-ref", re: /جاهز\s+للموديول\s+الجاي/g, label: "جاهز للموديول الجاي" },

  // Single-journey assumptions
  { cat: "single-journey", re: /أول\s+درس\s+ل(?:يك|ك)\s+في\s+المنصة/g, label: "أول درس ليك في المنصة" },
  { cat: "single-journey", re: /رحلتنا\s+(?:مع\s+بعض|سوا|في\s+المنصة)?/g, label: "رحلتنا" },
  { cat: "single-journey", re: /(?:بنينا|اتعلمنا|عملنا)\s+مع\s+بعض/g, label: "بنينا/اتعلمنا مع بعض" },
  { cat: "single-journey", re: /من\s+(?:أول|بداية)\s+(?:الكورس|المنصة|الرحلة)/g, label: "من أول الكورس/المنصة/الرحلة" },
  { cat: "single-journey", re: /لحد\s+دلوقتي\s+في\s+المنصة/g, label: "لحد دلوقتي في المنصة" },
  { cat: "single-journey", re: /كل\s+(?:اللي|اللى)\s+اتعلمتوه?/g, label: "كل اللي اتعلمته" },

  // "We" language
  { cat: "we-language", re: /(?:احنا|إحنا)\s+اتعلمنا/g, label: "احنا اتعلمنا" },
  { cat: "we-language", re: /(?:احنا|إحنا)\s+شفنا/g, label: "احنا شفنا" },
  { cat: "we-language", re: /(?:احنا|إحنا)\s+بنينا/g, label: "احنا بنينا" },
  { cat: "we-language", re: /(?:احنا|إحنا)\s+عملنا/g, label: "احنا عملنا" },
];
