...
Output:
  /mnt/documents/persona-sim-v10-intro-builder-{stamp}.md
  /mnt/documents/persona-sim-v10-intro-builder-{stamp}-raw.json
"""
...
def main():
    ...
    raw_path = OUT_DIR / f"persona-sim-v10-intro-builder-{stamp}-raw.json"
    ...
    md = [f"# Persona Sim v10 — 100 personas × {len(LESSONS)} lessons (Intro + Builder)\n"]
    ...
    md_path = OUT_DIR / f"persona-sim-v10-intro-builder-{stamp}.md"
