 ...
 *      في الـ 9 جداول المحددة داخل lessons-renumber-sql.ts.
 *
...
import { buildLessonRenumberMigration } from "./lessons-renumber-sql";
...
function emitMigration(renames: Rename[]): string {
  ...
  const sql = buildLessonRenumberMigration(renames);
