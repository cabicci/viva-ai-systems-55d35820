...
- خيار 1: تستنى لما تفضى وترد على الكل مرة واحدة.
- ****الإجابة الصحيحة** (correctIndex: 1):** كل تسجيل يتحفظ فورًا + رد ترحيب أوتوماتيك + تنبيه لمن يتابع.
- خيار 3: تقفل الفورم لحد ما تلحق ترد.
