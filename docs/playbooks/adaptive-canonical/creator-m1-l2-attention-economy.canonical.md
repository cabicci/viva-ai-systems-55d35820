...
Downstream locales from MSA only. **Attention Economy**, **Scroll Stop**, **Useful Angle** preserved as termsLocked — gloss on first use in each locale. Deferred: Bunny · Remotion · RAG · runtime. Mission remains observation-only — assistants must not write hooks or pick posts for the learner.
