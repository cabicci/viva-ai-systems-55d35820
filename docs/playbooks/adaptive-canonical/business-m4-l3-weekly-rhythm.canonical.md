...
| **lessonId** | `business-m4-l3-weekly-rhythm` |
| **pathId** | `business` |
| **moduleId** | `business-m4` |
| **productionTitle (ar-EG)** | الإيقاع الأسبوعي = ٤ مسارات |
| **productionRoute** | `/learn/business/business-m4-l3-weekly-rhythm` |
| **productionFile (read-only)** | `src/components/intro/lessons/business-m4-l3-weekly-rhythm.ts` |
...
| **oneAha** | 30 minutes — 3 numbers — 3 AI questions — one recorded decision |
...
| Asset | Status |
|-------|--------|
| `business-m4-l3-weekly-rhythm.ts` | **Frozen** |
| Bunny video | **Frozen** |
...
|---------|------------------|
| **Learning objective** | Design weekly review ritual: 3 numbers, 3 AI questions, one decision, fixed slot |
| **Mission rubric** | 60% طقس كامل · 40% قرار قابل للتسجيل |
| **Quiz intent** | 3 numbers then AI on change then one decision — not inbox triage |
| **Concepts locked** | Weekly Review |
| **Prerequisites** | `business-m4-l2-reactive-relapse` |
| **Next lesson** | `business-m4-l4-full-ecosystem` |
...
derivedFrom:
  ...
  productionFile: src/components/intro/lessons/business-m4-l3-weekly-rhythm.ts
...
objectives:
  - id: obj-1
    statement: Design weekly review ritual: 3 numbers, 3 AI questions, one decision, fixed slot
    measurable: true
...
concepts:
  - id: concept-1
    ...
    definition: Fixed time to review numbers signals and record one decision.
    mustPreserve: true
...
blocks:
  ...
  - role: quiz
    intent: 3 numbers then AI on change then one decision — not inbox triage
  - role: mission
    intent: Design weekly review ritual: 3 numbers, 3 AI questions, one decision, fixed slot
...
mission:
  ...
  intent: Design weekly review ritual: 3 numbers, 3 AI questions, one decision, fixed slot
  rubricIntent:
    - dimension: full_ritual
      weight: 60
      criteria: 3 numbers + 3 questions + fixed appointment
    - dimension: recordable_decision
      weight: 40
      criteria: Example weekly decision clear not generic
  forbiddenAssistantBehaviors:
    - write_full_submission
    - auto_pass_mission

termsLocked: [Weekly Review]

links:
  nextLessonId: business-m4-l4-full-ecosystem
  continuityNote: Full Ecosystem — five paths as one operating system
...
- **ماذا ستفهم؟** **Weekly Review (مراجعة أسبوعية)** تمنع انجراف البيزنس.

### Core idea — ٣٠ دقيقة

- ٣ أرقام + ٣ أسئلة **AI** + قرار واحد مكتوب.
- تعميق على إيقاع الأساس — ليس جدولًا جديدًا من الصفر.

### Quiz — correctIndex: 1

> **Quiz key (unchanged):** correctIndex: 1

- خيار 1: تفتح كل الرسائل وترد — عشان «تخلص».
- ****الإجابة الصحيحة** (correctIndex: 1):** ٣ أرقام → تسأل AI عن التغيّر والمعلّق → تسجّل قرار واحد.
- خيار 3: تقرأ ٥٠ مقال تسويق.

**التفسير:** الإجابة الصحيحة محفوظة من الإنتاج المصري — راجع النص أعلاه للسياق الكامل.
### Mission

| طقس كامل | 60% |
| قرار قابل للتسجيل | 40% |

### Confidence close

- **التالي:** **Full Ecosystem**.
