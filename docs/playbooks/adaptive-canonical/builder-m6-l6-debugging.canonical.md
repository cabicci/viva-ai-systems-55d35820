...
Downstream locales from MSA only. **Symptom**, **Expected**, **Actual**, **Debugging**, **Lovable** preserved. No stack trace or advanced dev concepts added. Deferred: Bunny · Remotion · RAG · runtime.
