...
Downstream locales from MSA only. **Embedding**, **Vector**, **Vector Search**, **chunks** preserved. Embeddings diagram = production reference. Deferred: Bunny · Remotion · RAG runtime.
