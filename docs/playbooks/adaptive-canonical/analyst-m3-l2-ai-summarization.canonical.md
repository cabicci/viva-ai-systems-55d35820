...
Downstream locales from MSA only. **Summarization**, **Context** preserved. Diagram `ai-summarization-flow` = production reference. Deferred: Bunny · Remotion · RAG · runtime. Mission stays small-sample AI practice — not big-data analysis.
