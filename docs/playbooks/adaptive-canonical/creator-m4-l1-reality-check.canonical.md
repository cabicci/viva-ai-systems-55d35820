...
Downstream locales from MSA only. **Iteration**, **Signal**, **Small Data** preserved as termsLocked — gloss on first use in each locale. Deferred: Bunny · Remotion · RAG · runtime. Mission remains idea-review practice — assistants must not rate ideas or pick test topics for the learner.
