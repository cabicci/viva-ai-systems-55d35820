...
Downstream locales from MSA only. **Hook Line**, **Thumbnail Text**, **CTR** preserved as termsLocked. Deferred: Bunny · Remotion · RAG · runtime. Mission requires learner's three versions and pick — assistants must not choose the best version for them.
