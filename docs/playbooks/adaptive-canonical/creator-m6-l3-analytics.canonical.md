...
Downstream locales from MSA only. **Watch Time**, **Save Rate**, **Action Metric** preserved as termsLocked. Deferred: Bunny · Remotion · RAG · runtime. Mission requires learner's post analysis — assistants must not assign metrics for them.
