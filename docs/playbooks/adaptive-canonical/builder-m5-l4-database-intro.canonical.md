...
Downstream locales from MSA only. **Database**, **Table**, **Frontend**, **Backend** preserved. No SQL introduced beyond production scope. Deferred: Bunny · Remotion · RAG · runtime.
