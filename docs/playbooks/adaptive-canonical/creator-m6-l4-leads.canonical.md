...
Downstream locales from MSA only. **Lead**, **Lead Magnet**, **CTA** preserved as termsLocked. Deferred: Bunny · Remotion · RAG · runtime. Mission is learner's offer design — assistants must not design the offer for them.
