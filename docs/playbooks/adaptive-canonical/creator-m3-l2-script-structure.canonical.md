...
Downstream locales from MSA only. **Value Block**, **Proof**, **CTA** preserved as termsLocked — gloss on first use in each locale. Deferred: Bunny · Remotion · RAG · runtime. Mission remains outline-writing practice — assistants must not write script outlines for the learner.
