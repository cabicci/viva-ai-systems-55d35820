...
Downstream locales from MSA only. **Product Request**, **Phase 2**, **Lovable**, **Prompt** preserved — gloss on first use. Screenshot = production reference. Deferred: Bunny · Remotion · RAG · runtime.
