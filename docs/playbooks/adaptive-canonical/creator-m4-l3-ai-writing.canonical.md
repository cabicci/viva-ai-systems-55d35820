...
Downstream locales from MSA only. **Context**, **Draft**, **Edit Pass** preserved as termsLocked. Deferred: Bunny · Remotion · RAG · runtime. Mission requires learner's own Prompt and edits — assistants must not generate and submit the full draft.
