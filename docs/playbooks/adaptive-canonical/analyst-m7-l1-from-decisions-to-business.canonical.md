...
- ****الإجابة الصحيحة** (correctIndex: 0):** برمجة الخصم في نظام الطلبات — يتطبق تلقائي من غير تدخل يدوي كل مرة.
- خيار 2: اتصال يدوي بكل عميل جديد.
- خيار 3: إعلان بس — واستنى الناس تتفاعل.
