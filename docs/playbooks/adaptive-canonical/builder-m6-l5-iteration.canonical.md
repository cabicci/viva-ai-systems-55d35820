...
Downstream locales from MSA only. **Iteration**, **Regression**, **Surgical Edit** preserved. Hex color examples from production kept. Deferred: Bunny · Remotion · RAG · runtime.
