...
- خيار 1: تكتب system prompt أطول يقوله «متخمّنش».
- ****الإجابة الصحيحة** (correctIndex: 1):** تختار مصدر FAQ أو قائمة أسعار وتربطه بالأوتوميشن قبل كل رد.
- خيار 3: توقف البوت وترد يدوي على كل الأسئلة.
