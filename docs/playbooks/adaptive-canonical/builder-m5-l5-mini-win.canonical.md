...
Downstream locales from MSA only. **Mini Win**, **MVP**, **Product Request** preserved. No React/SQL beyond production mention in quiz distractor. Deferred: Bunny · Remotion · RAG · runtime.
