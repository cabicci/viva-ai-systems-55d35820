...
Downstream locales from MSA only. **Hook**, **Pattern Break**, **Retention Start** preserved as termsLocked — gloss on first use in each locale. Deferred: Bunny · Remotion · RAG · runtime. Mission remains Hook-writing practice — assistants must not write Hooks or pick topics for the learner.
