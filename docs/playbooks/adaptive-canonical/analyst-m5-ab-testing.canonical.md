...
links:
  ...
  continuityNote: Interpretation Mistakes — right data wrong read
...
- **ماذا ستفهم؟** **A/B Test (اختبار A/B)** = تغيير واحد، مقياس واحد.

### Core idea

- A vs B — فرق واحد فقط. **Sample Size (حجم العيّنة)** — ٢–٤ أسابيع أفضل من ٣ أيام.

### Quiz — correctIndex: 0

- ٣ تغييرات = chaos — ليس A/B.
...
- **التالي:** **Interpretation Mistakes**.
