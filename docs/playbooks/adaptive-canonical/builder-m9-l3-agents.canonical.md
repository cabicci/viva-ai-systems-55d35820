...
Downstream locales from MSA only. **Agent**, **Tool**, **Boundaries** preserved. Agent loop diagram = production reference. Tool names from production only. Deferred: Bunny · Remotion · runtime.
