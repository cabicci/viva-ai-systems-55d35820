...
Downstream locales from MSA only. **Component**, **Route**, **Props** preserved. Code examples from production (`ChatBubble`, `/chat`) kept as references only. Deferred: Bunny · Remotion · RAG · runtime.
