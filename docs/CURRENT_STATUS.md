...
- سؤال العميل يبقى عند الخطأ. سجل الأسئلة والإجابات محدود بآخر 20 سؤالًا على جهاز العميل لكل حساب؛ الأسئلة مستقلة وليست محادثة متعددة الأدوار. يمكن مسح السجل من الصفحة.
