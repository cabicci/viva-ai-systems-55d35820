...
function Lesson({d,n,w,locale}:{d:any,n:number,w:any,locale:string}){
 ...
 {n<=2&&card(w.image,<figure className="overflow-hidden rounded-2xl border border-primary/20 bg-card"><img data-lesson-image src={n===1?images[locale]:images["lesson-02"][locale]} alt={d.pageIllustration?.title||d.imageBrief.altText} className="block w-full h-auto"/></figure>,BookOpen,'primary')}
