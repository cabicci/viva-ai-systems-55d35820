      ...
      rubric: [
        {
          ...
          weight: 70,
          criteria: [
            "فتحت أداة وابعت رسالة — أو محاولة مخطّطة (الرسالة + الأداة) لو مفيش حساب بعد.",
          ],
        },
        {
          label: "خطوة تالية",
