...
export const INTRO_SETUP_YOUR_AI_CONTENT: IntroLessonContent = [
  {
    ...
    block: {
      ...
      paragraphs: [
        ...
        "ليه دلوقتي؟ في الدرس اللي فات تعلمت تكتب Prompt أوضح. النهاردة هتجرّبه بإيدك مش بس على الورق.",
  ...
  },
  {
    ...
    block: {
      ...
      paragraphs: [
        ...
        "مش محتاج API ولا اشتراك مدفوع. النسخة المجانية (Free Tier) كافية لتجارب الدروس الأولى.",
