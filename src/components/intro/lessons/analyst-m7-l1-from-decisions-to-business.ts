...
export const ANALYST_M7_L1_FROM_DECISIONS_TO_BUSINESS_BLOCKS: IntroLessonContent = [
  ...
  },
  {
    ...
    block: {
      kind: "mission",
      intro:
        "المهمة دي ربط استراتيجي — مش خطة طويلة. اكتب هدف واحد لـ ٦ شهور + ٣ أرقام تتابع التقدّم + قرار أسبوعي واحد يخدم الهدف.\n\nمش لازم شركة — هدف شخصي، فريق، أو بيزنس يكفي. ممكن الـ AI يساعدك تصيغ — إنت تختار النهائي.",
      prompt:
        "في تسليمك اكتب:\n\n١) الهدف لـ ٦ شهور (جملة واحدة — شخصي، فريق، أو بيزنس):\n٢) ٣ أرقام progress (Metric + ليه دول):\n٣) قرار أسبوعي واحد من الريفيو يخدم الهدف:\n٤) Owner + Deadline للقرار:\n٥) إزاي هتراجع التقدّم كل شهر:",
      buttonLabel: "انسخ خطوات المهمة",
      copiedLabel: "اتنسخت ✓",
      template:
        "هدف ٦ شهور:\n[جملة واحدة — مثال: ١٠٠ عميل متكرر / ١٢ درس منظم / فريق يشتغل بإيقاع ثابت]\n\n٣ أرقام progress:\n1. [Metric + Target]\n2. [Metric + Target]\n3. [Metric + Target]\n\nقرار أسبوعي يخدم الهدف:\n[Action + Owner + Deadline]\n\nمراجعة شهرية:\n[إمتى + إزاي]",
      rubric: [
        {
          label: "هدف + أرقام",
          weight: 60,
          criteria: [
            "هدف ٦ شهور واضح + ٣ أرقام progress مربوطة.",
            "الهدف مربوط بسياق المتعلم الحقيقي — شخصي، فريق، أو بيزنس.",
          ],
        },
        {
          label: "ربط أسبوعي",
