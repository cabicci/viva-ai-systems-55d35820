...
export const BUSINESS_M2_L2_WEEKLY_RHYTHM_BLOCKS: IntroLessonContent = [
  ...
  },
  {
    ...
    block: {
      ...
      items: [
        ...
        "People — موظفين أو عملاء أو موردين أو شريك. الناس اللي معاك بيتطوّروا إزاي؟",
  ...
  },
  {
    icon: Sparkles,
    eyebrow: "Mission",
    title: "نفّذ Weekly Rhythm — ٣ مسارات أو أسبوع كامل",
    tone: "accent",
    block: {
      kind: "mission",
      intro: "الـ Rhythm مش نظرية — هو ممارسة.\n\nلو شغال لوحدك:\n٣ مسارات كفاية — مش لازم ٦ أيام ولا People track.\n\nلو متقدم: اختبر أسبوع كامل بـ ٤ مسارات.",
      prompt: "في تسليمك — اختَر مستوى واحد:\n\n【تسليم مبسّط — مقبول بالكامل (لو شغال لوحدك)】\n١) Rhythm بـ ٣ مسارات (Growth / Operations / Self) × أهم ٣ مهام لكل واحد.\n٢) صورة من الكالندر أو جدول بسيط.\n٣) كل مسار خد كم ساعة فعلاً؟\n\n【تسليم كامل — اختياري】\n٤) Rhythm بـ ٤ مسارات (شامل People) × ٦ أيام.\n٥) أكبر تحدي في الالتزام — وإزاي تعاملت.\n٦) تعديل واحد للأسبوع الجاي.",
      ...
      rubric: [
        {
          ...
          weight: 50,
          criteria: [
            "التسليم المبسّط: ٣ مسارات متوازنة — مقبول بالكامل للشغال لوحده.",
            "التسليم الكامل (اختياري): ٤ مسارات ظاهرة + Self مش أقل من ٤ ساعات.",
          ],
        },
        {
          label: "تنفيذ حقيقي",
          weight: 50,
          criteria: [
            "التسليم المبسّط: تتبع ساعات لـ ٣ مسارات — مقبول بالكامل.",
            "التسليم الكامل (اختياري): تأمل في التحدي + تعديل للأسبوع الجاي.",
          ],
        },
      ],
    },
