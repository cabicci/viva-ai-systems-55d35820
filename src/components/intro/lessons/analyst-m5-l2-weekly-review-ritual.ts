...
export const ANALYST_M5_L2_WEEKLY_REVIEW_RITUAL_BLOCKS: IntroLessonContent = [
  ...
  },
  {
    ...
    block: {
      ...
      items: [
        ...
        { term: "Four Numbers Dashboard (M5-L1)", meaning: "لوحة متابعة بتعرض أهم ٤ أرقام في شغلك بشكل بسيط.", example: "المحاسب يجمع أهم ٤ أرقام (مبيعات، مصروفات، ديون، ربح) في صفحة واحدة." },
  ...
  },
  {
    ...
    block: {
      kind: "numberedList",
      items: [
        "افتح الـ Dashboard (الـ ٤ أرقام من M5-L1 — أو شيت يدوي بـ ٤ خانات لو لسه مفيش لوحة).",
        "اسأل: «إيه اللي اتغيّر من الأسبوع اللي فات؟».",
        "حدّد قرار واحد للأسبوع الجاي (Action + Owner + Deadline من M4-L2).",
    ...
    block: {
      ...
      items: [
        ...
        },
        {
          ...
          correctIndex: 1,
          explanation: "الدرس بيشدد على 'حدّد قرار واحد للأسبوع الجاي (Action + Owner + Deadline من M4-L2)' عشان نضمن التنفيذ."
        },
        {
          id: "apply3",
          bloom: "apply",
  ...
  },
  {
    ...
    block: {
      kind: "mission",
      intro:
        "مراجعة أسبوعية ٢٠ دقيقة بتغيّر الشغل أكتر من dashboard بتفتحه يوميًا. اعملها دلوقتي على الأسبوع اللي فات. لو مفيش dashboard جاهز، اعمل الريفيو على شيت الـ ٤ أرقام.",
      prompt:
