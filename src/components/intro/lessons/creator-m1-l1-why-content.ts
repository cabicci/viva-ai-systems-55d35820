  ...
  },
  {
    ...
    block: {
      ...
      paragraphs: [
        ...
        "الذكاء الاصطناعي هنا مساعد بس — أفكار، Hooks، اختصار، وتنقيح — مش بياخد مكانك في الكتابة والتجربة.",
        "من دلوقتي: خط واحد ولونين ثابتين على بوستاتك؛ الهوية الكاملة هتتظبط في آخر المسار.",
      ],
    },
  },
  {
