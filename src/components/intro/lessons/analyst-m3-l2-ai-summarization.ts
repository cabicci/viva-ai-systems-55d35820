...
export const ANALYST_M3_L2_AI_SUMMARIZATION_BLOCKS: IntroLessonContent = [
  ...
  },
  {
    ...
    block: {
      kind: "paragraphs",
      paragraphs: [
        "انسخ البيانات (رسائل/فواتير/ملاحظات) في أي أداة AI (ChatGPT أو Claude أو Gemini أو غيرهم).",
        "Prompt: «دي رسائل عملاء آخر أسبوع. استخرج: ١) كام طلب؟ ٢) أكتر ٣ أسئلة تكرّرت؟ ٣) في أي شكوى متكرّرة؟ ٤) أي pattern غير عادي؟»",
        "الـ AI بيرجّعلك ملخّص في نقاط — جاهز للقرار.",
        "لو البيانات كبيرة جدًا ومش عارف تنقلها — RAG من Builder M9 اختياري ومتقدم؛ مش مطلوب في الدرس ده.",
      ],
    },
  },
  {
    ...
    block: {
      ...
      items: [
        ...
        },
        {
          ...
          options: [
            "تاخد قرار فوري بتعديل عملية التوصيل ومراجعة جودة المنتجات",
          ...
          correctIndex: 0,
          explanation: "الـ AI بيرجعلك ملخّص في نقاط جاهز للقرار. وبما إن الـ AI بيطلعلك الـ patterns و الشكاوى المتكررة، دي بتكون مؤشرات قوية لمشاكل لازم يتم التحرك عليها فورًا."
        },
        {
          id: "apply3",
          bloom: "apply",
          question: "لو عندك بيانات كتير في Database ومش قادر تنقلها كلها لـ AI، إيه أنسب خطوة تبدأ بيها في درس Analyst ده عشان تطلع أنماط من غير أدوات متقدمة؟",
          options: [
            "تبني RAG على الـ Database — حل متقدم واختياري (زي Builder M9)، مش مطلوب هنا",
            "تنسخ كل الفواتير والملاحظات يدويًا في ملف Excel وبعدين تحطها في الـ AI",
            "تحلّل عينة صغيرة (١٠–٥٠ سجل) في أي أداة AI — كفاية للبداية"
          ],
          correctIndex: 2,
          explanation: "في Analyst، ابدأ بعينة صغيرة في أي أداة AI — ده كفاية تطلع Insights وتاخد قرار. RAG حل متقدم واختياري لو البيانات ضخمة جدًا بعدين؛ مش شرط في الدرس ده."
        }
      ]
    },
  },
