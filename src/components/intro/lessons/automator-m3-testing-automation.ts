...
export const AUTOMATOR_M3_TESTING_AUTOMATION_BLOCKS: IntroLessonContent = [
  {
    ...
    block: {
      kind: "paragraphs",
      paragraphs: [
        "هتفهم إيه؟ الاختبار بيمنع أخطاء محرجة في الأتمتة — مش رفاهية تقنية.",
        "ليه دلوقتي؟ بعد Error Handling، عندك workflow شغّال — محتاج تتأكد إنه مش هيبعت رسالة غلط لـ ٥٠٠ عميل.",
        "هتعمل إيه بعد الدرس؟ هتعمل test checklist لأوتوميشن واحد: unit + full-flow + edge cases + مراجعة يدوية.",
      ],
    },
  },
  {
    ...
    block: {
      kind: "paragraphs",
      paragraphs: [
        "شغّلت workflow جديد على production من غير اختبار. الرسالة فيها «مرحبًا undefined» — لـ ٣٠٠ عميل.",
  ...
  },
  {
    ...
    block: {
      kind: "paragraphs",
      paragraphs: [
        "Unit test: اختبر خطوة واحدة — مثال: «لو الاسم فاضي، إيه اللي يحصل؟»",
        "Integration test: شغّل الـ flow كامل ببيانات تجريبية — مش بيانات عملاء حقيقيين.",
        "Edge cases: فاضي، غلط، مكرر — ٣ حالات على الأقل قبل الـ live.",
        "Manual review: حد يشوف النتيجة بعينه قبل ما تفتح على الكل — آخر بوابة.",
    ...
    block: {
      ...
      items: [
        ...
        },
        {
          ...
          meaning: "تشغّل الـ workflow كامل من أوله لآخره ببيانات وهمية.",
