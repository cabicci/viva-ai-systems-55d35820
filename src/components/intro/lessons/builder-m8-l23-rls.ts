  ...
  },
  {
    ...
    block: {
      ...
      paragraphs: [
        ...
        "الدرس اللي فات عرفنا إزاي السيرفر بيتأكد \"إنت مين\" عن طريق **كارت الدخول المؤقت (JWT)**. النهاردة هنعرف إزاي **المخزن الذكي (Database)** نفسه بيتأكد \"إنت مسموح لك تشوف إيه؟\".",
      ],
    },
  },
  {
