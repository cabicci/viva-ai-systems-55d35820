...
export const WHAT_IS_AI_CONTENT: IntroLessonContent = [
  ...
  },
  {
    ...
    block: {
      kind: "mission",
      intro:
        "ممنوع تخلص الدرس ده نظري. اختار حاجة بسيطة من يومك وجرّب AI واحد فيها.\n\nافتح ChatGPT أو Gemini → اكتب السؤال → انسخ الرد → ارجع الصقه هنا.",
      prompt:
        "في تسليمك اكتب:\n\n١) إيه الحاجة اللي طلبتها من الـ AI؟\n٢) أنهي أداة استخدمت؟ (ChatGPT / Gemini / Claude / غيرهم)\n٣) الرد جالك إيه؟ — في سطر واحد:\n٤) إيه أكتر حاجة فاجأتك في التجربة؟",
      ...
      rubric: [
        {
          label: "تجربة فعلية",
          weight: 80,
          criteria: ["في طلب اتبعت لـ AI ورد اتشاف."],
        },
        {
          label: "ملاحظة شخصية",
          weight: 20,
          criteria: ["في حاجة لفتت انتباهك من التجربة (إيجابي أو سلبي)."],
        },
      ],
    },
  },
  {
    ...
    block: {
      kind: "caseStudy",
      title: "بنينا مساعد AI جوّاني عشان تشوف الفكرة على أرض الواقع",
      summary:
        "بدل ما نقولّك «الـ AI أداة عملية»، عملنا أداة فعلًا داخل المنصة. لما تسأل المساعد، هو بيقرا الدرس الأول قبل ما يرد، عشان رده يطلع مفيد ومربوط باللي إنت بتتعلمه. ده مثال حي إن الـ AI مش سحر — هو أداة بنبنيها وبنوجّهها.",
      bullets: [
