      ...
      rubric: [
        {
          ...
          weight: 50,
          criteria: [
            "التكاليف مذكورة بأرقام — دقيقة أو تقديرات مُوسَمة \"تقريبي\" — مقبول.",
            "العمولات والرسوم مش منسية (حتى لو تقدير).",
          ],
        },
        {
          label: "تنفيذ فعلي",
          weight: 50,
          criteria: [
            "تعديل مقترح واحد على الأقل — تنفيذ النهارده اختياري للمبتدئ.",
            "النتيجة المتوقعة من التعديل مذكورة (حتى لو تقدير).",
          ],
        },
      ],
    },
