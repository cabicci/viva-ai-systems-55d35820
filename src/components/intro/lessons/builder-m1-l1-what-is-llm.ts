...
export const BUILDER_M1_WHAT_IS_LLM_BLOCKS: IntroLessonContent = [
  {
    ...
    block: {
      kind: "paragraphs",
      paragraphs: [
        "هتفهم إيه؟ ليه الـ AI بيرد بثقة حتى لما يكون غلط — وإزاي ده يأثر على أي ميزة AI هتبنيها.",
        "ليه دلوقتي؟ قبل ما تكتب Prompt أو تضيف مساعد في منتجك، لازم تعرف: الـ AI بيتوقّع كلام مش بيتحقّق من الحقيقة.",
        "هتعمل إيه بعد الدرس؟ هتسأل سؤال واقعي وتكتب طريقة تتحقّق بيها من الإجابة.",
      ],
    },
  },
  {
  ...
  },
  {
    ...
    block: {
      kind: "paragraphs",
      paragraphs: [
        "LLM = نموذج لغوي كبير. بيتدرب على كمّ هائل من النصوص، وبيتعلّم: «بعد الكلمات دي، إيه الكلمة اللي غالبًا بتيجي؟»",
        "لما يردّ بثقة، ده مش دليل إنه «فاهم» — ده دليل إن الجملة شكلها منطقي في لغته.",
        "في Builder: أي مساعد أو ميزة AI في منتجك هتشتغل بنفس المنطق. التحقّق من الحقائق مسؤوليتك إنت — مش الموديل.",
        "استخدمه في الكتابة والتلخيص والترجمة والأفكار. راجع أي أرقام أو تواريخ أو أسماء قبل ما تعرضها للمستخدم.",
      ],
    },
  },
  {
      ...
      items: [
        {
          ...
          meaning: "برنامج متخصّص في فهم وتوليد الكلام البشري — بيتوقّع الكلمة الجاية، مش بيبحث في قاعدة بيانات.",
  ...
  },
  {
    ...
    block: {
      kind: "paragraphs",
      paragraphs: [
        "فهمت إيه؟ الـ AI بيتوقّع لغة بثقة — مش بيضمن الحقيقة. ده أساس أي ميزة AI هتبنيها.",
