...
export const BUSINESS_M4_L5_BUSINESS_OS_DASHBOARD_BLOCKS: IntroLessonContent = [
  ...
  },
  {
    ...
    block: {
      kind: "mission",
      intro:
        "دي مهمة بناء ختامية. صمّم لوحة بسيطة: ٤ أرقام تتابعها، ٣ إشارات متكررة تهمك، و Prompt واحد تسأله للـ AI كل أسبوع لملخص وقرار.\n\nلو لسه مبتدئ: Dashboard بـ ٣ أقسام يكفي (قرارات / أرقام اليوم / ملاحظات) — Google Doc أو ورقة مقبولين.\n\nمش مطلوب شيت جاهز — مطلوب تصميم تقدر تنفّذه في أسبوع.",
      prompt:
        "في تسليمك — اختَر مستوى واحد:\n\n【تسليم مبسّط — مقبول بالكامل】\n١) ٣ أقسام: قرارات / أرقام اليوم / ملاحظات (Google Doc أو ورقة)\n٢) Prompt أسبوعي للـ AI (انسخه كامل)\n\n【تسليم كامل — اختياري】\n٣) ٤ أرقام + مصدر كل واحد\n٤) ٣ إشارات متكررة\n٥) Prompt الملخص الأسبوعي للـ AI (انسخه كامل)",
      ...
      rubric: [
        {
          ...
          criteria: [
            ...
            "التسليم الكامل (اختياري): ٤ أرقام + ٣ إشارات — كل واحد له معنى في بيزنسك.",
          ],
        },
        {
          label: "Prompt ملخص",
