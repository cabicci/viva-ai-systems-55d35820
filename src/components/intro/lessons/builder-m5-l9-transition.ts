...
export const BUILDER_M5_TRANSITION_BLOCKS: IntroLessonContent = [
  {
    ...
    title: "خلصت Phase 1. دلوقتي هنحوّل الـ AI لتطبيق حقيقي.",
    tone: "primary",
    block: {
      kind: "paragraphs",
      paragraphs: [
        "في الـ 8 دروس اللي فاتوا، فهمت AI فعلاً — إزاي بيفكر، إزاي بتكلّمه، إزاي بتتحكم في رده. ده Phase 1.",
        "بس الـ AI لوحده مش تطبيق. لما عميلك يفتح موبايله ويكلم AI خاص بيك، هو محتاج: واجهة يكلم منها، مكان يحفظ كلامه، وحاجة تعرفه إن ده هو فعلاً. ده Phase 2.",
        "مهم تفهم نقطة: إحنا مش داخلين كورس Web Development. إحنا بنركّب الـ 3 طبقات اللي بتخلي الـ AI بتاعك يوصل لناس حقيقيين. كل مصطلح هتسمعه هنا، هتلاقي جنبه تشبيه من حياتك — مش عشان نبسّط، عشان ده فعلاً اللي بيحصل.",
        "مش محتاج تكون مبرمج. هنمشي خطوة بخطوة، وفي آخر Phase 2 هتكون قادر تبني أول AI app حقيقي بنفسك.",
      ],
    },
  },
  {
