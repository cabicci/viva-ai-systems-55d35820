...
export const BUILDER_M5_TRANSITION_BLOCKS: IntroLessonContent = [
  {
    icon: Compass,
    eyebrow: "نقلة جديدة",
    title: "الـ AI ذكي، بس مش أبلكيشن. إزاي؟",
    tone: "primary",
    block: {
      kind: "paragraphs",
      paragraphs: [
        "لحد دلوقتي، كل اللي عملناه كان مجرد \"كلام\" مع الـ AI. بتسأله سؤال، بيرد عليك. خلصنا.",
        "بس الأبلكيشن الحقيقي أكبر من مجرد شات. فيه زراير، فيه صفحات، فيه مكان تحفظ فيه بياناتك وتدخل باليوزر نيم والباسورد.",
        "إزاي تحوّل \"شات ذكي\" لأبلكيشن كامل الناس تستخدمه؟ ده اللي هنعرفه في الـ 5 دروس الجايين.",
      ],
    },
  },
  {
