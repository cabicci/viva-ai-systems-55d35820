...
export const BUILDER_M9_EMBEDDINGS_BLOCKS: IntroLessonContent = [
  {
    ...
    block: {
      kind: "paragraphs",
      paragraphs: [
        "هتفهم إيه؟ إزاي Embeddings تلاقي المعنى — مش الكلمة الحرفية.",
        "ليه دلوقتي؟ RAG محتاج يدوّر في ملفاتك — والبحث العادي مش بيفهم «قصدك إيه».",
  ...
  },
  {
    ...
    block: {
      ...
      paragraphs: [
        ...
        "عشان RAG يشتغل صح، محتاج بحث بالمعنى — مش بالحروف.",
      ],
    },
  },
  {
    ...
    block: {
      kind: "paragraphs",
      paragraphs: [
        "Embedding = تحوّل أي نص لقايمة أرقام (vector) بتمثّل «مكانه على خريطة المعاني».",
        "الجمل اللي معناها قريب — الأرقام بتاعتها قريبة. «قطة بتلعب» و«كلب بيجري» أقرب من «البورصة».",
        "لما العميل يسأل، بنحوّل سؤاله لـ vector وندوّر على أقرب chunks — حتى لو الكلمات مختلفة.",
      ],
    },
  },
  {
    ...
    block: {
      ...
      right: {
        label: "صح — embedding",
        body: "السؤال يتحوّل لـ vector — يلاقي chunks عن «توليد الرد» و«الـ LLM output». نفس المعنى، كلمات مختلفة.",
      },
    },
  },
  {
    ...
    block: {
      ...
      items: [
        ...
        {
          term: "Vector Search",
          meaning: "البحث عن أقرب vectors للسؤال — مش match حرفي.",
