  ...
  },
  {
    ...
    block: {
      ...
      items: [
        ...
        { term: "Leading Question (bias) village", meaning: "سؤال غرضه يوجه اللي قدامك لإجابة معينة إنت عاوزها.", example: "زي ما تسأل حد \"مش بذمتك القميص ده تحفة؟\" إنت كدة بتجبره يمدح." },
        { term: "No-Data Question village", meaning: "سؤال مستحيل ترد عليه عشان مفيش بيانات متسجلة أصلاً تخصه.", example: "لما صاحب محل يسألك: \"مين أكتر زبون اشترى في 1990؟\" وهو أصلًا فاتح 2010!" },
        ...
        { term: "NPS (Net Promoter Score) village", meaning: "مقياس بنعرف بيه الزبون راضي عننا وهينصح بينا غيره ولا لأ.", example: "لو فاتح ابلكيشن وبسألك \"بنسبة كام ترشحنا لصحابك؟\" عشان أعرف إنت راضي ولا لأ." },
      ],
    },
  },
  {
