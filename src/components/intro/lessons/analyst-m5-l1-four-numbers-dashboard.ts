...
export const ANALYST_M5_L1_FOUR_NUMBERS_DASHBOARD_BLOCKS: IntroLessonContent = [
  ...
  },
  {
    ...
    block: {
      kind: "mission",
      intro:
        "المهمة دي تصميم عملي — مش ديكور. اختار ٤ أرقام تناسب سياقك — بيزنس، تعلّم، محتوى، شخصي، أو فريق — واكتبهم في dashboard بسيط (Sheet، Notion، ورقة).\n\nمش مطلوب أداة معقّدة — مطلوب ٤ أرقام تقدر تقراهم كل أسبوع وتقرّر.",
      prompt:
      ...
      rubric: [
        {
          ...
          criteria: [
            ...
            "الأرقام مناسبة لسياق المتعلم (بيزنس، تعلّم، محتوى، شخصي، أو فريق) — مش لازم Leads/Revenue.",
