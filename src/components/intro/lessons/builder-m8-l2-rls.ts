...
export const BUILDER_M7_RLS_BLOCKS: IntroLessonContent = [
  {
    ...
    block: {
      ...
      paragraphs: [
        ...
        "ليه دلوقتي؟ JWT بيقول «مين إنت» — RLS بيقول «إيه اللي مسموح تشوفه» من البيانات.",
  ...
  },
  {
    ...
    block: {
      kind: "paragraphs",
      paragraphs: [
        "JWT بيثبت هويتك. RLS Policy بتركّب فلتر على كل سؤال للمخزن: «ارجّع بس الصفوف اللي user_id بتاعها = أنا».",
        "الفلتر ده جوه المخزن نفسه — مش في كود التطبيق بس.",
        "يعني: حتى لو Backend نسي شرط WHERE، الحارس على السطر يرفض يورّي بيانات مش بتاعتك.",
      ],
    },
  },
  {
    ...
    block: {
      ...
      left: {
        ...
        body: "تكتب `WHERE user_id = currentUser` في كل API. نسيت مرة واحدة في endpoint — أسرار عميل اتكشفت. زي قفل كل البيبان وسايب شباك مفتوح.",
      },
      right: {
      ...
      items: [
        {
          ...
          meaning: "أمان على مستوى السطر — قواعد على المخزن نفسه بتفلتر أي query قبل ما ترجع نتايج.",
