...
export const VALUE_HOOKS: Record<string, string> = {
  ...
  "builder-m6": "بعد الموديول ده هيكون عندك أول صفحة شغّالة من Lovable بإيدك.",
  "builder-m7": "بعد الموديول ده تطبيقك هيقدر يعرف مين اليوزر، ومش هيبقى أي حد يقرا داتا أي حد.",
  "builder-m8": "بعد الموديول ده هتعرف تخزّن داتا تطبيقك في database حقيقية بدون كود.",
  "builder-m9": "بعد الموديول ده هتبني assistant بيرد على عملاء شركتك من ملفاتك الخاصة (RAG).",
  "builder-m10": "بعد الموديول ده تطبيقك هيبقى أونلاين بـ domain خاص بيك — وعنده أول ١٠ يوزرز.",
  ...
  /* Automator */
  "automator-m0": "بعد الدرس ده هتعرف فين بالظبط الأتمتة تنفعك في شغلك دلوقتي.",
  ...
  /* Analyst */
  "analyst-m0": "بعد الدرس ده هتفهم ليه الـ insight بيغيّر شغلك أكتر من أي automation.",
  ...
  /* Business */
  "business-m0": "بعد الدرس ده هتفهم الفرق بين operator بيشتغل و leader بيقود.",
