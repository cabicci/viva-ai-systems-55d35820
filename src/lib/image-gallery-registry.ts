...
export const IMAGE_GALLERY: GalleryItem[] = [
  ...
  // Automator Path
  { number: 54, slug: "automator-m1-l1-where-you-are", title: "أنت فين في الخريطة؟", group: "Automator M0", image: au1 },
  { number: 55, slug: "automator-m2-l3-decide-what-to-automate", title: "تأتمت إيه بالظبط؟", group: "Automator M1", image: au2 },
  { number: 56, slug: "automator-m2-l2-spot-patterns", title: "اكتشاف الأنماط", group: "Automator M1", image: au3 },
  { number: 57, slug: "automator-m2-l1-systems-view", title: "كل شغل = System", group: "Automator M1", image: au4 },
  { number: 58, slug: "automator-m3-l1-tools-landscape", title: "Tools Landscape", group: "Automator M2", image: au5 },
  { number: 59, slug: "automator-m3-l2-triggers-actions", title: "Triggers و Actions", group: "Automator M2", image: au6 },
  { number: 60, slug: "automator-m3-l3-filters-routers", title: "Filters و Routers", group: "Automator M2", image: au7 },
  { number: 61, slug: "automator-m4-l2-webhooks-api", title: "Webhooks و API", group: "Automator M3", image: au8 },
  { number: 62, slug: "automator-m4-l1-connect-database", title: "اربط بـ Database", group: "Automator M3", image: au9 },
  { number: 63, slug: "automator-m4-l3-error-handling", title: "Error Handling", group: "Automator M3", image: au10 },
  { number: 64, slug: "automator-m5-l1-llm-in-flow", title: "LLM في الـ Flow", group: "Automator M4", image: au11 },
  { number: 65, slug: "automator-m5-l2-rag-in-n8n", title: "RAG في n8n", group: "Automator M4", image: au12 },
  { number: 66, slug: "automator-m5-l3-agents", title: "Agents", group: "Automator M4", image: au13 },
  { number: 67, slug: "automator-m6-l1-lead-capture", title: "استقبال Leads", group: "Automator M5", image: au14 },
  { number: 68, slug: "automator-m6-l2-whatsapp-flow", title: "WhatsApp Flow", group: "Automator M5", image: au15 },
  { number: 69, slug: "automator-m6-l3-follow-up", title: "متابعة تلقائية + CRM", group: "Automator M5", image: au16 },
  { number: 70, slug: "automator-m7-l1-closing-loop", title: "إغلاق الـ Loop", group: "Automator M6", image: au17 },

  // Analyst Path (inline SVG diagrams)
  { number: 72, slug: "analyst-m1-l1-from-automation-to-insight", lessonSlug: "analyst-m1-l1-from-automation-to-insight", title: "بياناتك جاهزة — دلوقتي بتسأل", group: "Analyst M0", diagramId: "decision-loop" },
  { number: 73, slug: "analyst-m2-l1-feeling-to-question", lessonSlug: "analyst-m2-l1-feeling-to-question", title: "حوّل الشعور لسؤال", group: "Analyst M1", diagramId: "feeling-to-question-table" },
  { number: 74, slug: "analyst-m2-l2-right-question-rule", lessonSlug: "analyst-m2-l2-right-question-rule", title: "السؤال الصح أهم من الإجابة", group: "Analyst M1", diagramId: "question-scorecard" },
  { number: 75, slug: "analyst-m3-l1-three-sources", lessonSlug: "analyst-m3-l1-three-sources", title: "المصادر الثلاثة", group: "Analyst M2", diagramId: "three-sources-merge" },
  { number: 76, slug: "analyst-m3-l2-ai-summarization", lessonSlug: "analyst-m3-l2-ai-summarization", title: "AI = أسرع محلّل عندك", group: "Analyst M2", diagramId: "ai-summarization-flow" },
  { number: 77, slug: "analyst-m4-l1-pattern-vs-outlier", lessonSlug: "analyst-m4-l1-pattern-vs-outlier", title: "Pattern أم Outlier؟", group: "Analyst M3", diagramId: "pattern-vs-outlier" },
  { number: 78, slug: "analyst-m4-l2-decision-rule", lessonSlug: "analyst-m4-l2-decision-rule", title: "كل تفسير ينتهي بقرار", group: "Analyst M3", diagramId: "decision-chain" },
  { number: 79, slug: "analyst-m5-l1-four-numbers-dashboard", lessonSlug: "analyst-m5-l1-four-numbers-dashboard", title: "٤ أرقام بس", group: "Analyst M4", diagramId: "four-kpi-dashboard" },
  { number: 80, slug: "analyst-m5-l2-weekly-review-ritual", lessonSlug: "analyst-m5-l2-weekly-review-ritual", title: "Review أسبوعي = ١٥ دقيقة", group: "Analyst M4", diagramId: "weekly-review-timeline" },
  { number: 81, slug: "analyst-m6-l1-question-mistakes", lessonSlug: "analyst-m6-l1-question-mistakes", title: "أخطاء الأسئلة", group: "Analyst M5", diagramId: "question-rewrite" },
  { number: 82, slug: "analyst-m6-l2-interpretation-mistakes", lessonSlug: "analyst-m6-l2-interpretation-mistakes", title: "أخطاء التفسير", group: "Analyst M5", diagramId: "correlation-causation" },
  { number: 83, slug: "analyst-m7-l1-from-decisions-to-business", lessonSlug: "analyst-m7-l1-from-decisions-to-business", title: "قراراتك جاهزة → Business", group: "Analyst M6", diagramId: "decision-backlog" },

  // Business Path (inline SVG diagrams)
  { number: 84, slug: "business-m1-l1-from-decisions-to-leadership", lessonSlug: "business-m1-l1-from-decisions-to-leadership", title: "من Operator لـ Leader", group: "Business M0", diagramId: "operator-vs-leader" },
  { number: 85, slug: "business-m2-l1-reactive-vs-proactive", lessonSlug: "business-m2-l1-reactive-vs-proactive", title: "Reactive vs Proactive", group: "Business M1", diagramId: "reactive-vs-proactive-day" },
  { number: 86, slug: "business-m2-l2-weekly-rhythm", lessonSlug: "business-m2-l2-weekly-rhythm", title: "أسبوعك = ٤ مسارات", group: "Business M1", diagramId: "weekly-theme-days" },
  { number: 87, slug: "business-m3-l1-customer-lifecycle", lessonSlug: "business-m3-l1-customer-lifecycle", title: "دورة حياة العميل", group: "Business M2", diagramId: "customer-lifecycle-funnel" },
  { number: 88, slug: "business-m3-l2-retention-flow", lessonSlug: "business-m3-l2-retention-flow", title: "Follow-up Flow", group: "Business M2", diagramId: "followup-cadence" },
  { number: 89, slug: "business-m4-l1-strategic-operational-admin", lessonSlug: "business-m4-l1-strategic-operational-admin", title: "٣ أنواع شغل", group: "Business M3", diagramId: "soa-bars" },
  { number: 90, slug: "business-m4-l2-delegate-or-automate", lessonSlug: "business-m4-l2-delegate-or-automate", title: "Delegate ولا Automate؟", group: "Business M3", diagramId: "delegate-automate-matrix" },
  { number: 91, slug: "business-m5-l1-readiness-signals", lessonSlug: "business-m5-l1-readiness-signals", title: "علامات الجاهزية للتوسع", group: "Business M4", diagramId: "readiness-signals" },
  { number: 92, slug: "business-m5-l2-system-then-people", lessonSlug: "business-m5-l2-system-then-people", title: "System الأول — الناس بعدين", group: "Business M4", diagramId: "system-then-people" },
  { number: 93, slug: "business-m6-l1-reactive-relapse", lessonSlug: "business-m6-l1-reactive-relapse", title: "الرجوع لـ Reactive Mode", group: "Business M5", diagramId: "reactive-relapse-cycle" },
  { number: 94, slug: "business-m6-l2-premature-scaling", lessonSlug: "business-m6-l2-premature-scaling", title: "توسع قبل الأوان", group: "Business M5", diagramId: "premature-scaling-cliff" },
  { number: 95, slug: "business-m7-l1-full-ecosystem", lessonSlug: "business-m7-l1-full-ecosystem", title: "الـ ٥ مسارات في يومك", group: "Business M6", diagramId: "ecosystem-loop" },
];