...
export const IMAGE_GALLERY: GalleryItem[] = [
  ...
  { number: 85, slug: "business-m2-l1-reactive-vs-proactive", lessonSlug: "business-m2-l1-reactive-vs-proactive", title: "Reactive vs Proactive", group: "Business M2", diagramId: "reactive-vs-proactive-day" },
  { number: 86, slug: "business-m2-l2-weekly-rhythm", lessonSlug: "business-m2-l2-weekly-rhythm", title: "أسبوعك = ٤ مسارات", group: "Business M2", diagramId: "weekly-theme-days" },
  { number: 87, slug: "business-m3-l1-customer-lifecycle", lessonSlug: "business-m3-l1-customer-lifecycle", title: "دورة حياة العميل", group: "Business M3", diagramId: "customer-lifecycle-funnel" },
  { number: 88, slug: "business-m3-l2-retention-flow", lessonSlug: "business-m3-l2-retention-flow", title: "Follow-up Flow", group: "Business M3", diagramId: "followup-cadence" },
  { number: 89, slug: "business-m4-l1-strategic-operational-admin", lessonSlug: "business-m4-l1-strategic-operational-admin", title: "٣ أنواع شغل", group: "Business M4", diagramId: "soa-bars" },
  { number: 90, slug: "business-m4-l2-delegate-or-automate", lessonSlug: "business-m4-l2-delegate-or-automate", title: "Delegate ولا Automate؟", group: "Business M4", diagramId: "delegate-automate-matrix" },
  { number: 91, slug: "business-m5-l1-readiness-signals", lessonSlug: "business-m5-l1-readiness-signals", title: "علامات الجاهزية للتوسع", group: "Business M5", diagramId: "readiness-signals" },
  { number: 92, slug: "business-m5-l2-system-then-people", lessonSlug: "business-m5-l2-system-then-people", title: "System الأول — الناس بعدين", group: "Business M5", diagramId: "system-then-people" },
  { number: 93, slug: "business-m6-l1-reactive-relapse", lessonSlug: "business-m6-l1-reactive-relapse", title: "الرجوع لـ Reactive Mode", group: "Business M6", diagramId: "reactive-relapse-cycle" },
  { number: 94, slug: "business-m6-l2-premature-scaling", lessonSlug: "business-m6-l2-premature-scaling", title: "توسع قبل الأوان", group: "Business M6", diagramId: "premature-scaling-cliff" },
  { number: 95, slug: "business-m7-l1-full-ecosystem", lessonSlug: "business-m7-l1-full-ecosystem", title: "الـ ٥ مسارات في يومك", group: "Business M7", diagramId: "ecosystem-loop" },
];