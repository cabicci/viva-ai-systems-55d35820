...
export const DOCS_CONTROLLED_V1 = resolve(
  REPO_ROOT,
  "docs/lesson-visuals/controlled-v1",
);
...
export const DOCS_CONTROLLED_V1_CAPTURE = resolve(
  DOCS_CONTROLLED_V1,
  "capture",
);
...
export const CLASSIFICATION_100_PATH = resolve(
  DOCS_CONTROLLED_V1,
  "classification-100.json",
);
export const GOLDEN_REFERENCES_PATH = resolve(
  DOCS_CONTROLLED_V1,
  "golden-references.json",
);
export const MEDIA_MAP_COPY_PATH = resolve(
  DOCS_CONTROLLED_V1_INPUTS,
  "ar-eg-media-map.md",
);
export const RIGHTS_LEDGER_PATH = resolve(
  DOCS_CONTROLLED_V1_RIGHTS,
  "ledger.json",
);
export const CAPTURE_LEDGER_PATH = resolve(
  DOCS_CONTROLLED_V1_CAPTURE,
  "ledger.json",
);

export const PRODUCTION_MANIFEST_PATH = resolve(
  DOCS_CONTROLLED_V1,
  "PRODUCTION_MANIFEST.json",
);
export const PILOT_MANIFEST_PATH = resolve(
  DOCS_CONTROLLED_V1,
  "PILOT_MANIFEST.json",
);
export const UNRESOLVED_LEDGER_PATH = resolve(
  DOCS_CONTROLLED_V1,
  "UNRESOLVED_LEDGER.json",
);

/** External (out-of-git) authoring inputs. Only used by local regeneration; never required in CI. */
export const EXTERNAL_MEDIA_MAP_DIR =
  "E:/Masaarat/Worktrees/_external-audits/ar-eg-100-media-map";
...
export const ARTIFACTS_CONTACT_SHEETS_DIR = resolve(
  ARTIFACTS_ROOT,
  "contact-sheets",
);
...
export const AR_EG_LESSON_TS_DIR = resolve(
  REPO_ROOT,
