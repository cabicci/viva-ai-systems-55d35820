...
DROP FUNCTION IF EXISTS public.match_knowledge_chunks(extensions.vector(1536), integer, text, text, text, double precision);
...
GRANT EXECUTE ON FUNCTION public.match_knowledge_chunks(extensions.vector(1536), integer, text, text, text, double precision) TO authenticated, service_role;